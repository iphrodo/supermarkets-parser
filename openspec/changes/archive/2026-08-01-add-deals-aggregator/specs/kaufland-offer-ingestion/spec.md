...
When a product tile's image URL contains a numeric barcode-like segment (e.g. `.../8606018614950_BG_P`), the system SHALL extract it into an `ean` field on the offer.
